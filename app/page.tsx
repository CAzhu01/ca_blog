...
export default function HomePage() {
  const projects = [
    {
      title: "项目一",
      description: "这是一个项目的简短描述。介绍这个项目是做什么的，以及它解决了什么问题。",
      link: "#",
    },
    {
      title: "项目二",
      description: "这是另一个项目的简短描述。可以突出你在这个项目中使用的技术。",
      link: "#",
    },
    {
      title: "项目三",
    ...
    {
      title: "项目四",
      description: "这是第四个项目的简短描述。可以是你的个人作品或参与的开源项目。",
      link: "#",
    },
  ];
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section id="contact" className="text-center">
        ...
        <div className="flex justify-center items-center gap-8">
          ...
          <Link href="https://github.com/your-github" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-lg hover:text-primary transition-colors">
